      ...
      <div className={cn("flex relative", className)}>
        <div className="flex relative overflow-hidden flex-row gap-1 items-center w-min h-min">
          ...
          <div
            ...
            style={{
              height: `${height}px`,
              maskImage: 'linear-gradient(rgba(0,0,0,0) 0%, rgb(0,0,0) 43.69%, rgba(0,0,0,0) 100%)',
              WebkitMaskImage: 'linear-gradient(rgba(0,0,0,0) 0%, rgb(0,0,0) 43.69%, rgba(0,0,0,0) 100%)',
            }}
          >
            <div
